  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className={Styles["promo__description-block"]}>
          ...
          <button onClick={handleButtonClick} className={Styles["button promo__button"]} >
            {codeIsVisible === true 
        ...
        <img src="./public/images/promo-illustration.svg" alt="Собака" className={Styles["promo__image"]}/>
      </section>
    )
}
